...
#%%
tokentest = Tokenizer()
tokentest.fit_on_texts(['apple','pen'])
word_index = tokentest.word_index
word_counts = tokentest.word_counts
word_docs = tokentest.word_docs

print(word_index)
print(word_counts)
print(word_docs)

print(tokentest.seq(['apple', 'apple', 'pen','dog']))